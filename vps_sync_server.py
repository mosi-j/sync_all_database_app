...
from my_database_info import get_database_info, vps1_local_access, server_remote_access_from_vps
...
obj_1 = SyncDataBase(source_db_info=get_database_info(pc_name=vps1_local_access, database_name=tsetmc_and_analyze_data),
                   destination_db_info=get_database_info(pc_name=vps1_local_access, database_name=website_data),
...
obj_2 = SyncDataBase(source_db_info=get_database_info(pc_name=vps1_local_access, database_name=tsetmc_and_analyze_data),
                     destination_db_info=get_database_info(pc_name=server_remote_access_from_vps, database_name=tsetmc_and_analyze_data),
                     max_packet_size=max_packet_size,
                     commit_mod=commit_mod,
                     sync_period_time=sync_period_time,
...
obj_3 = SyncDataBase(source_db_info=get_database_info(pc_name=vps1_local_access, database_name=tsetmc_and_analyze_data),
                     destination_db_info=get_database_info(pc_name=server_remote_access_from_vps, database_name=tsetmc_and_analyze_data),
                     max_packet_size=max_packet_size,
                     commit_mod=commit_mod,
                     sync_period_time=sync_period_time,
...
while True:
    ...
    obj_1.run(force=force)
    obj_2.run(force=force)
    obj_3.run(force=True)
